      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-brand-gradient flex items-center justify-center text-white shadow-md">
              <Sparkles size={20} fill="currentColor" />
            </div>
            {/* Text is now always dark (brand-950 or brand-900) because background is light */}
            <span className={`font-bold text-2xl tracking-tight ${isScrolled ? 'text-brand-900' : 'text-brand-950'}`}>
              AiMOON
            </span>
          </div>
